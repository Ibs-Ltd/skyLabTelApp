 ...
 */
package tel.skylab.skylabtel.linphone.settings;
...
import tel.skylab.skylabtel.linphone.settings.widget.BasicSetting;
import tel.skylab.skylabtel.linphone.settings.widget.ListSetting;
import tel.skylab.skylabtel.linphone.settings.widget.SettingListenerBase;
import tel.skylab.skylabtel.linphone.settings.widget.SwitchSetting;
import tel.skylab.skylabtel.linphone.settings.widget.TextSetting;
...
public class CallSettingsFragment extends SettingsFragment {
                ...
                new SettingListenerBase() {
                    ...
                    public void onListValueChanged(int position, String newLabel, String newValue) {
                        try {
                            ...
                            //                            mPrefs.setMediaEncryption("SRTP");
    ...
    private void updateValues() {
        ...
        //        mMediaEncryption.setValue(String.valueOf(MediaEncryption.SRTP.toInt()));
