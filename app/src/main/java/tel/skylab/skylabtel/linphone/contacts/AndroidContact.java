 ...
 */
package tel.skylab.skylabtel.linphone.contacts;
...
class AndroidContact implements Serializable {
    ...
    boolean isLinphoneAddressMimeEntryAlreadyExisting(String value) {
        ...
        String selection = Data.RAW_CONTACT_ID + " = ? AND " + Data.MIMETYPE + " = ? AND data1 = ?";
    ...
    void addNumberOrAddress(String value, String oldValueToReplace, boolean isSIP) {
        ...
        if (oldValueToReplace != null) {
            ...
            if (isSIP) {
                ...
                String select = Data.CONTACT_ID + "=? AND " + Data.MIMETYPE + "=? AND data1=?";
                String[] args =
                        new String[] {
                            mAndroidId, CommonDataKinds.Phone.CONTENT_ITEM_TYPE, oldValueToReplace
                        };
    ...
    void removeNumberOrAddress(String noa, boolean isSIP) {
        ...
        if (mAndroidId == null) {
            ...
            if (isSIP) {
                ...
                String select = Data.CONTACT_ID + "=? AND " + Data.MIMETYPE + "=? AND data1=?";
                String[] args =
                        new String[] {mAndroidId, CommonDataKinds.Phone.CONTENT_ITEM_TYPE, noa};
