...
import tel.skylab.skylabtel.linphone.dialer.views.AddressType;
...
public class CallManager {
    ...
    public void newTextOutgoingCall(String address) {
        newOutgoingCall(address, address);
    }

    public void newOutgoingCall(String to, String displayName) {

        db = SkylabRoomDatabase.getAppDatabase(mContext);
        String timestamp =
                (DateFormat.format("dd-MM-yyyy hh:mm:ss", new java.util.Date()).toString());
        RecentCallsEntity recentCallsEntity = new RecentCallsEntity(displayName, to, timestamp);
        db.recentCallsDao().insert(recentCallsEntity);
